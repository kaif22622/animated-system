...
public class GetVehiclesCommand extends SimulatorCommand {
  ...
  public void execute(WebServerSession session, JsonObject command) {
    ...
    for (int i = 0; i < vehicles.size(); i++) {
      ...
      colorJsonObject.addProperty("r", currVehicle.getRgb().getRed());
      colorJsonObject.addProperty("g", currVehicle.getRgb().getGreen());
      colorJsonObject.addProperty("b", currVehicle.getRgb().getBlue());
      colorJsonObject.addProperty("alpha", currVehicle.getRgb().getAlpha());
