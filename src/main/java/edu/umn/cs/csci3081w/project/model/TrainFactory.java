...
public class TrainFactory implements VehicleFactory {
  ...
  public void returnVehicle(Vehicle vehicle) {
    if (vehicle instanceof ElectricTrainDecorator || vehicle instanceof ElectricTrain) {
      storageFacility.incrementElectricTrainsNum();
    } else if (vehicle instanceof DieselTrainDecorator || vehicle instanceof DieselTrain) {
