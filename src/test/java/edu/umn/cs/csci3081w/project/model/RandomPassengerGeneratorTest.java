...
public class RandomPassengerGeneratorTest {
  ...
  private RandomPassengerGenerator testRandomPassengerGeneratorZero;
  ...
  public void setUp() {
    ...
    Stop testStop1 = new Stop(0, "test stop 1",
        new Position(-93.243774, 44.972392));
    Stop testStop2 = new Stop(1, "test stop 2",
        new Position(-93.25631, 44.963211));
    ...
    List<Double> probabilitiesZero = new ArrayList<Double>();
    List<Stop> stopsZero = new ArrayList<Stop>();
    testRandomPassengerGeneratorZero = new RandomPassengerGenerator(stopsZero,
        probabilitiesZero);
  }
