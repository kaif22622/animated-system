...
public class VehicleTest {
  ...
  public void testUpdate() {
    ...
    assertEquals(3, testVehicle.getPassengers().size());
  ...
  public void testProvideInfo() {
    ...
    commandFromClient.addProperty("command", "observedVehicle");
    webServerSessionSpy.onMessage(commandFromClient.toString());
    ArgumentCaptor<JsonObject> messageCaptor = ArgumentCaptor.forClass(JsonObject.class);
    verify(webServerSessionSpy, times(1)).sendJson(messageCaptor.capture());
    JsonObject commandToClient = messageCaptor.getValue();
    String expectedCommand = "observedVehicle";
    assertEquals(expectedCommand, commandToClient.get("command").getAsString());
    ...
    assertEquals(expectedText, commandToClient.get("text").getAsString());
  }
  ...
  public void testProvideInfoForSmallBus() {
    VehicleConcreteSubject vehicleConcreteSubject = new VehicleConcreteSubject(webServerSessionSpy);
    Vehicle testSmallBus = new SmallBusDecorator(testVehicle);
  ...
  public void testProvideInfoForLargeBus() {
    VehicleConcreteSubject vehicleConcreteSubject = new VehicleConcreteSubject(webServerSessionSpy);
    Vehicle testLargeBus = new LargeBusDecorator(testVehicle);
  ...
  public void testProvideInfoForElectricTrain() {
    VehicleConcreteSubject vehicleConcreteSubject = new VehicleConcreteSubject(webServerSessionSpy);
    Vehicle testElectricTrain = new ElectricTrainDecorator(testVehicle);
  ...
  public void testProvideInfoForDieselTrain() {
    VehicleConcreteSubject vehicleConcreteSubject = new VehicleConcreteSubject(webServerSessionSpy);
    Vehicle testDieselTrain = new DieselTrainDecorator(testVehicle);
  ...
  /**
   * Test to see CO2 history.
   */
  @Test
  public void testProvideInfoForNoCO2() {
    VehicleConcreteSubject vehicleConcreteSubject = new VehicleConcreteSubject(webServerSessionSpy);
    Vehicle testSmallBus = new SmallBusDecorator(testVehicle);
    testSmallBus.setVehicleSubject(vehicleConcreteSubject);
    testSmallBus.provideInfo();
   ...
   */
  @Test
  public void testProvideInfoForCO2() {
    VehicleConcreteSubject vehicleConcreteSubject = new VehicleConcreteSubject(webServerSessionSpy);
    Vehicle testSmallBus = new SmallBusDecorator(testVehicle);
    testSmallBus.setVehicleSubject(vehicleConcreteSubject);
    testSmallBus.update();
